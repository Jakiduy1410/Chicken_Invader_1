# FILE: sprites.py - Định nghĩa các đối tượng đồ họa trong game.
...
class Player(pygame.sprite.Sprite):
    """Đại diện cho máy bay của người chơi."""
...
class Enemy(pygame.sprite.Sprite):
    """Đại diện cho một con gà trong đội hình."""
    ...
    def _draw_attack_effect(self, now):
        """Vẽ hiệu ứng tấn công đè lên boss."""
        effect_frames = []
...
class Bullet(pygame.sprite.Sprite):
    """Đại diện cho một viên đạn do Player bắn ra."""
...
class Egg(pygame.sprite.Sprite):
    """Đại diện cho quả trứng do Enemy thả ra."""
